...
% initialize matrices
testFit = nan(numFolds,6); % columns: var ex, correlation, llh increase, mse, # of spikes, length of test data
trainFit = nan(numFolds,6); % columns: var ex, correlation, llh increase, mse, # of spikes, length of train data
